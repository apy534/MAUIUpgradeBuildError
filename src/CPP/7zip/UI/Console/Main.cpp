...
)
{
  ...
  else if (isExtractGroupCommand || options.Command.CommandType == NCommandType::kList)
  {
    ...
    {
      #ifdef ENV_NDK
      CExtractCallbackProxy *ecs = new CExtractCallbackProxy;
      ecs->PorgessCallback = porgessCallback;
      #else
  ...
  else if (options.Command.IsFromUpdateGroup())
  {
    ...
    #ifdef ENV_NDK
    CUpdateCallbackProxy callback;
    callback.PorgessCallback = porgessCallback;
    #else
